...
locals {
  ...
  cluster_location = length(google_container_cluster.primary) > 0 ? google_container_cluster.primary[0].location : null
  cluster_region   = var.regional ? var.region : (local.cluster_location != null ? join("_", slice(split("_", local.cluster_location ), 0, 2 )) : null)
